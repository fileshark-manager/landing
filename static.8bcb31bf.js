...
var _reactSyntaxHighlighter = __webpack_require__(131);

var _reactSyntaxHighlighter2 = _interopRequireDefault(_reactSyntaxHighlighter);

var _hljs = __webpack_require__(132);
...
var _Setup = __webpack_require__(130);

var _Setup2 = _interopRequireDefault(_Setup);

var _Usage = __webpack_require__(134);
...
var _BrowsersSupport = __webpack_require__(139);
...
var _DocumentationInfo = __webpack_require__(137);
...
// module
exports.push([module.i, "*,:after,:before{box-sizing:border-box}html{position:relative;min-width:320px}body,html{height:100%}body{display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-box-orient:vertical;-webkit-box-direction:normal;-webkit-flex-direction:column;-ms-flex-direction:column;flex-direction:column;width:100%;background:#fff}img{max-width:100%;height:auto}button{margin:0;padding:0;background:none;border:0;text-decoration:none;line-height:normal;outline:none;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}@font-face{font-family:montserratbold;src:url(" + escape(__webpack_require__(22)) + ");src:url(" + escape(__webpack_require__(22)) + "?#iefix) format(\"embedded-opentype\"),url(" + escape(__webpack_require__(142)) + "#montserratbold) format(\"svg\"),url(" + escape(__webpack_require__(143)) + ") format(\"woff2\"),url(" + escape(__webpack_require__(144)) + ") format(\"woff\"),url(" + escape(__webpack_require__(145)) + ") format(\"truetype\");font-weight:400;font-style:normal}@font-face{font-family:montserratitalic;src:url(" + escape(__webpack_require__(23)) + ");src:url(" + escape(__webpack_require__(23)) + "?#iefix) format(\"embedded-opentype\"),url(" + escape(__webpack_require__(146)) + "#montserratitalic) format(\"svg\"),url(" + escape(__webpack_require__(147)) + ") format(\"woff2\"),url(" + escape(__webpack_require__(148)) + ") format(\"woff\"),url(" + escape(__webpack_require__(149)) + ") format(\"truetype\");font-weight:400;font-style:normal}@font-face{font-family:montserratlight;src:url(" + escape(__webpack_require__(24)) + ");src:url(" + escape(__webpack_require__(24)) + "?#iefix) format(\"embedded-opentype\"),url(" + escape(__webpack_require__(150)) + "#montserratlight) format(\"svg\"),url(" + escape(__webpack_require__(151)) + ") format(\"woff2\"),url(" + escape(__webpack_require__(152)) + ") format(\"woff\"),url(" + escape(__webpack_require__(153)) + ") format(\"truetype\");font-weight:400;font-style:normal}@font-face{font-family:montserratmedium;src:url(" + escape(__webpack_require__(25)) + ");src:url(" + escape(__webpack_require__(25)) + "?#iefix) format(\"embedded-opentype\"),url(" + escape(__webpack_require__(154)) + "#montserratmedium) format(\"svg\"),url(" + escape(__webpack_require__(155)) + ") format(\"woff2\"),url(" + escape(__webpack_require__(156)) + ") format(\"woff\"),url(" + escape(__webpack_require__(157)) + ") format(\"truetype\");font-weight:400;font-style:normal}@font-face{font-family:montserratregular;src:url(" + escape(__webpack_require__(26)) + ");src:url(" + escape(__webpack_require__(26)) + "?#iefix) format(\"embedded-opentype\"),url(" + escape(__webpack_require__(158)) + "#montserratregular) format(\"svg\"),url(" + escape(__webpack_require__(159)) + ") format(\"woff2\"),url(" + escape(__webpack_require__(160)) + ") format(\"woff\"),url(" + escape(__webpack_require__(161)) + ") format(\"truetype\");font-weight:400;font-style:normal}@font-face{font-family:montserratsemibold;src:url(" + escape(__webpack_require__(27)) + ");src:url(" + escape(__webpack_require__(27)) + "?#iefix) format(\"embedded-opentype\"),url(" + escape(__webpack_require__(162)) + "#montserratsemibold) format(\"svg\"),url(" + escape(__webpack_require__(163)) + ") format(\"woff2\"),url(" + escape(__webpack_require__(164)) + ") format(\"woff\"),url(" + escape(__webpack_require__(165)) + ") format(\"truetype\");font-weight:400;font-style:normal}a,abbr,acronym,address,applet,article,aside,audio,b,big,blockquote,body,canvas,caption,center,cite,code,dd,del,details,dfn,div,dl,dt,em,embed,fieldset,figcaption,figure,footer,form,h1,h2,h3,h4,h5,h6,header,hgroup,html,i,iframe,img,ins,kbd,label,legend,li,mark,menu,nav,object,ol,output,p,pre,q,ruby,s,samp,section,small,span,strike,strong,sub,summary,sup,table,tbody,td,tfoot,th,thead,time,tr,tt,u,ul,var,video{margin:0;padding:0;border:0;font:inherit;font-size:100%;vertical-align:baseline}body{font-weight:400;font-family:montserratlight,Helvetica,Arial,sans-serif;font-size:15px;line-height:1.4;color:#333;-webkit-font-smoothing:antialiased}iframe,img,p{margin-bottom:1.3em}iframe,img{position:relative;display:block;max-width:100%;margin-left:auto;margin-right:auto}h1,h2,h3,h4,h5,h6{color:rgba(51,51,51,.9)}h1{font-family:montserratsemibold,Helvetica,Arial,sans-serif;font-size:54px;line-height:1.1}@media screen and (max-width:1024px){h1{font-size:44px;line-height:1.2}}@media screen and (max-width:767px){h1{font-size:30px;line-height:1.2}}h2{font-family:montserratsemibold,Helvetica,Arial,sans-serif;font-size:44px;line-height:1.2}@media screen and (max-width:1024px){h2{font-size:30px;line-height:1.2}}@media screen and (max-width:767px){h2{font-size:25px;line-height:1.2}}h3{font-family:montserratsemibold,Helvetica,Arial,sans-serif;font-size:20px;line-height:1.2}@media screen and (max-width:767px){h3{font-size:18px;line-height:1.2}}h4{font-family:montserratsemibold,Helvetica,Arial,sans-serif;font-size:18px;line-height:1.2}@media screen and (max-width:767px){h4{font-size:16px;line-height:1.2}}h5{font-family:montserratlight,Helvetica,Arial,sans-serif;font-size:18px;line-height:1.5}@media screen and (max-width:767px){h5{font-size:15px}}h6{font-size:12px;line-height:1.3}a{color:#333;text-decoration:underline}ol,ul{margin-bottom:1.3em;padding-left:25.2px}ul li{list-style:disc;list-style-position:outside}strong{font-family:montserratbold,Helvetica,Arial,sans-serif}i{font-family:montserratitalic,Helvetica,Arial,sans-serif}", ""]);
...
//# sourceMappingURL=static.8bcb31bf.js.map